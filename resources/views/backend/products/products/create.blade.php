        ...
        <div class="row small-spacing">
            ...
            <div class="col-lg-12 col-xs-12">
                <div class="box-content">
                    ...
                    <div class="clearfix">
                        <h4 class="box-title pull-right">{{ __('public.add_products_title') }}</h4>
                        <!-- /.bo-title -->
                    </div>

                    <form action="{{ route('admin.products.store') }}" method="POST" id="formProduct" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea rows="4" class="form-control" name="{{ $locale }}[description]"></textarea>
                            </div>
                            @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea rows="4" class="form-control" name="{{ $locale }}[shipping_info]"></textarea>
                            </div>
                            @endforeach
