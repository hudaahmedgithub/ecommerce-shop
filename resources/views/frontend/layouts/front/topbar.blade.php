                ...
                <ul class="dropdown-menu cart" role="menu">
                                ...
                                @foreach ($cartContent as $item)
                                    ...
                                    <li id="_item-{{ $item['id'] }}">
                                        <a href="{{ route('products.show', ['id' => $item['id']]) }}" class="product-img">
                                            <img src="{{ Storage::url($item['attributes']['featured_image']) }}" alt="{{ $item['name'] }}" width="50" height="50">
                                        </a>
                                        ...
                                        <div class="product-info">
                                            ...
                                            <h3 class="product-price">{{ $item['price'] }}eg</h3>
                                        </div>
                    ...
                    <li>
                        <div class="cart-footer">
                            <a href="{{ url('shopping-cart') }}" class="pull-left">
                                <i class="fa fa-cart-plus mr-5"></i> View Cart
                            </a>

                            <a href="{{ url('check-out') }}" class="pull-right">
    ...
    <div class="container">
        <div class="row display-table">
            ...
            <div class="col-sm-8 vertical-align text-center">
                <form method="GET" id="search" action="{{ url('web.search') }}">
